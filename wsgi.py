...
def create_users():
    ...
    """
    from blog.models import User
    db.session.add(User(username="test_1", email="test_1@gb.gb", is_staff=True, password=generate_password_hash("test_1")))
...
#     print("done! created users:", admin)
    ...
    from blog.models import User
    admin = User(username='superadmin', email='test_admin@email.com', is_staff=True)
